...
function afterDOMLegenda() {
    ...
    if (!localStorage.getItem('teclaTempo1')) {
        localStorage.setItem('teclaTempo1', '0');
    }

    if (!localStorage.getItem('valorTempo1')) {
        localStorage.setItem('valorTempo1', '4');
    }

    if (!localStorage.getItem('teclaTempo2')) {
        localStorage.setItem('teclaTempo2', ',');
    }

    if (!localStorage.getItem('valorTempo2')) {
        localStorage.setItem('valorTempo2', '6');
    }
    ...
    for (let i = 0; i < linhas.length; i++) {
        ...
        if (contaLinha !== 3) {
            if (contaLinha === 1) {
                ...
                let totalMilissegundos = (minutos * 60 + segundos) * 1000;

                blocoObjeto.inicio = totalMilissegundos;
                blocoObjeto.fim = 0;

                if (listaBlocosAux.length > 0) {
                    listaBlocosAux[listaBlocosAux.length - 1].fim = blocoObjeto.inicio;
                }
            }
        ...
        if (contaLinha === 3 && blocoObjeto.legenda !== '') {
...
function parsearArquivoLegendaSRT(legendas) {
    let listaBlocosAux = [];
    let linhas = legendas.split('\r\n');
...
function criarModal() {
    ...
    // Qual legenda copiar
    var selectQualLegendaCopiar = document.createElement('select');
    var labelQualLegendaCopiar = document.createElement('label');
    labelQualLegendaCopiar.textContent = 'Qual legenda copiar';
    labelQualLegendaCopiar.style.marginRight = '5px';
    labelQualLegendaCopiar.style.marginBottom = '5px';
    labelQualLegendaCopiar.style.display = 'inline-block';

    var optionLegendaRodapeHtml = document.createElement('option');
    optionLegendaRodapeHtml.value = 'legendaRodapeHtml';
    optionLegendaRodapeHtml.textContent = 'Legenda Inferior';

    var optionLegendaTopoHtml = document.createElement('option');
    optionLegendaTopoHtml.value = 'legendaTopoHtml';
    optionLegendaTopoHtml.textContent = 'Legenda Superior';

    selectQualLegendaCopiar.appendChild(optionLegendaTopoHtml);
    selectQualLegendaCopiar.appendChild(optionLegendaRodapeHtml);

    selectQualLegendaCopiar.addEventListener('change', function () {
        localStorage.setItem('qualLegendaCopiar', selectQualLegendaCopiar.value)
    });
    // FIM Qual legenda copiar

    // Tempo 1
    var labelTempo1 = document.createElement('label');
    labelTempo1.textContent = 'Tempo 1';
    labelTempo1.style.marginRight = '5px';
    labelTempo1.style.marginBottom = '5px';
    labelTempo1.style.display = 'inline-block';

    var inputTecla1 = document.createElement('input');
    inputTecla1.type = 'text';
    inputTecla1.maxLength = 1;
    inputTecla1.style.display = 'inline-block';
    inputTecla1.style.width = '50px';
    inputTecla1.style.marginRight = '5px';
    inputTecla1.value = localStorage.getItem('teclaTempo1');

    // Não funciona netflix
    inputTecla1.addEventListener('keydown', function (e) {
        e.stopPropagation();
    });
    inputTecla1.addEventListener('input', function () {
        localStorage.setItem('teclaTempo1', inputTecla1.value);
    });

    var inputTempo1 = document.createElement('input');
    inputTempo1.type = 'number';
    inputTempo1.max = 15;
    inputTempo1.style.display = 'inline-block';
    inputTempo1.style.width = '50px';
    inputTempo1.value = localStorage.getItem('valorTempo1');

    inputTempo1.addEventListener('keydown', function (e) {
        e.stopPropagation();
    });
    inputTempo1.addEventListener('input', function () {
        localStorage.setItem('valorTempo1', inputTempo1.value);
    });
    // FIM Tempo 1
    ...
    inputTecla2.maxLength = 1;
    inputTecla2.style.display = 'inline-block';
    inputTecla2.style.width = '50px';
    inputTecla2.style.marginRight = '5px';
    inputTecla2.value = localStorage.getItem('teclaTempo2');

    inputTecla2.addEventListener('keydown', function (e) {
        e.stopPropagation();
    });
    inputTecla2.addEventListener('input', function () {
        localStorage.setItem('teclaTempo2', inputTecla2.value);
    });

    var inputTempo2 = document.createElement('input');
    inputTempo2.type = 'number';
    inputTempo2.max = 15;
    inputTempo2.style.display = 'inline-block';
    inputTempo2.style.width = '50px';
    inputTempo2.value = localStorage.getItem('valorTempo2');

    inputTempo2.addEventListener('keydown', function (e) {
        e.stopPropagation();
    });
    inputTempo2.addEventListener('input', function () {
        localStorage.setItem('valorTempo2', inputTempo2.value);
    });
    // FIM Tempo 1
    ...
    modalContent.appendChild(document.createElement('br'));
    modalContent.appendChild(document.createElement('br'));
    modalContent.appendChild(labelQualLegendaCopiar);
    modalContent.appendChild(selectQualLegendaCopiar);

    modalContent.appendChild(document.createElement('br'));
    modalContent.appendChild(labelTempo1);
    modalContent.appendChild(inputTecla1);
    modalContent.appendChild(inputTempo1);

    modalContent.appendChild(document.createElement('br'));
    modalContent.appendChild(labelTempo2);
    modalContent.appendChild(inputTecla2);
    modalContent.appendChild(inputTempo2);
    ...
    if (location.host.includes("netflix")) {
        document.querySelector('video').parentElement
            .parentElement.parentElement.parentElement.parentElement.appendChild(modal);
    } else if (location.host.includes("youtube")) {
    ...
    inputTopo.addEventListener('change', (event) => {
        ...
        reader.onload = (e) => {
            ...
            let legendas = parsearArquivoLegendaSRT(contents);
    ...
    inputRodape.addEventListener('change', (event) => {
        ...
        reader.onload = (e) => {
            ...
            if (linhas[0].includes(':')) {
                let legendasYoutube = parsearArquivoLegendaYoutube(contents);
                tratarLegendaRodape(legendasYoutube);
                return;
            }
...
function tratarLegendaTopo(legendas) {
    if (!document.getElementById('legendaTopoHtml')) {
        ...
        if (location.host.includes("youtube")) {
            document.querySelector('video').parentElement.parentElement.appendChild(legendaTopoHtml);
        } else {
            if (document.querySelector('video')) {
...
function tratarLegendaRodape(legendas) {
    if (!document.getElementById('legendaRodapeHtml')) {
        ...
        if (location.host.includes("youtube")) {
            document.querySelector('video').parentElement.parentElement.appendChild(legendaRodapeHtml);
        } else {
            if (document.querySelector('video')) {
...
function addInputsTopo(modalContent) {
    ...
    lagTopoInput.addEventListener('keydown', function (e) {
        e.stopPropagation();
    });

    lagTopoInput.addEventListener('input', function (e) {
...
function addInputsRodape(modalContent) {
    ...
    lagRodapeInput.addEventListener('keydown', function (e) {
        e.stopPropagation();
    });
