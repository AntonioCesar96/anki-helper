...
var atrasoLegendaRodape = 1000;
var atrasoLegendaTopo = 1000;
...
function afterDOMLegenda() {
    ...
    async function checkKey(e) {
        ...
        if (e.keyCode == '49') { // 1
            ...
            // Rodape
            var fileInputRodape = document.createElement('input');
            fileInputRodape.type = 'file';

            var parent = document.querySelector('body');
            parent.insertBefore(fileInputRodape, parent.firstChild);

            fileInputRodape.addEventListener('change', (event) => {
                ...
                reader.onload = (e) => {
                    ...
                    if (!document.getElementById('legendaRodape')) {
                        legendaRodape = criarLegendaRodape();
                        document.body.appendChild(legendaRodape);
                    }
                    ...
                    legendaRodapeInterval = setInterval(() => {
                        ...
                        const currentTime = (video.currentTime * 1000) + atrasoLegendaRodape;
                        const subtitle = legendas.find(sub => currentTime >= sub.inicio && currentTime <= sub.fim);

                        if (subtitle) {
                            if (legendaRodape.innerHTML != subtitle.legenda) {
                                legendaRodape.innerHTML = subtitle.legenda;
                                legendaRodape.style.display = 'block';
                            }
                        } else {
                            legendaRodape.innerHTML = '';
                            legendaRodape.style.display = 'none';
                        }
            ...
            // Topo
            var fileInputTopo = document.createElement('input');
            fileInputTopo.type = 'file';

            var parent = document.querySelector('body');
            parent.insertBefore(fileInputTopo, parent.firstChild);

            fileInputTopo.addEventListener('change', (event) => {
                const files = event.target.files;
                let file = files[0];
                ...
                reader.onload = (e) => {
                    ...
                    if (!document.getElementById('legendaTopo')) {
                        legendaTopo = criarLegendaTopo();
                        document.body.appendChild(legendaTopo);
                    }
                    ...
                    legendaTopoInterval = setInterval(() => {
                        ...
                        const currentTime = (video.currentTime * 1000) + atrasoLegendaTopo;
                        const subtitle = legendas.find(sub => currentTime >= sub.inicio && currentTime <= sub.fim);

                        if (subtitle) {
                            if (legendaTopo.innerHTML != subtitle.legenda) {
                                legendaTopo.innerHTML = subtitle.legenda;
                                legendaTopo.style.display = 'block';
                            }
                        } else {
                            legendaTopo.innerHTML = '';
                            legendaTopo.style.display = 'none';
                        }
...
function criarLegendaRodape() {
    ...
    legenda.setAttribute('id', 'legendaRodape');
...
function criarLegendaTopo() {
    let legenda = document.createElement('div');
    legenda.setAttribute('id', 'legendaTopo');
    legenda.style.position = 'fixed';
